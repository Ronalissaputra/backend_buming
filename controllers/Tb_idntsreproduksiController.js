...
import Tb_idntsreproduksi from "../models/Tb_idntsreproduksiModel.js";

export const getIdntsreproduksi = async (req, res) => {
  try {
    let response;
    if (req.role === "superadmin") {
      response = await Tb_idntsreproduksi.findAll({
